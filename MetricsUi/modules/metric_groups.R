...
# 
# group1_metrics <- list(
#   list(name = "DirectTraffic", weight = NULL)
# )
# 
# group1 <- list(name = "Traffic Sources", metrics = group1_metrics, value = 3.0)

# metricsGroups <- list(group1)
# 
...
#     list(name="Average Time Spent Per Page e", weight = NULL, result=NULL)
#   )
# 
#   groups <- list(
